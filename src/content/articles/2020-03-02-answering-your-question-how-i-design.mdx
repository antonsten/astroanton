...
So a couple of days ago I asked if there was anything specific that they were curious about. I'll continue to do this, so if you want to ask me anything, just sign up for [my newsletter](/newsletter) and join our Slack!

![Slack conversation](slack_figma.png)

Johan wanted to get a more detailed look into some of my work from a design perspective and, more specifically, what tools I use. I've previously outlined which [tools I use](/tools) (and I do my best to keep that page updated), but more specifically when it comes to design, there's a short and a longer answer. The short answer is unfortunately just as ambiguous as when Maureen (who is also on Slack!) asked me what kind of work I do as a [UX-designer](/uxdesigner).
