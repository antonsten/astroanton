...
For those unfamiliar with Polestar, it’s a relatively new brand in the Volvo “family” but operates independently. They currently only offer one model, the [Polestar 2](https://www.polestar.com/se/polestar-2/) - they previously offered a hybrid called Polestar 1 - but Polestar 3-5 are all under production. The [Polestar website](https://www.polestar.com/) is very clean and straightforward, just as the [UI in their car is](https://hmi-app.polestar.com) - all built on Android Auto, a departure from most car makers who develop their own tech.

![Polestar 2](polestar.png)

## The pyramid of user needs

As avid readers of my blog are familiar with, I often [refer to Maslow’s pyramid of needs applied to our user experiences.](/great-ux/) The idea is that to craft great user experiences, our products need to be:
...
![pyramid_of_ux.png](pyramid_of_ux.png)
...
![pyramid_of_trust.png](pyramid_of_trust.png)
