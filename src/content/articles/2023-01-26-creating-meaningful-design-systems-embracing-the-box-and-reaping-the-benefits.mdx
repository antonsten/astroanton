...
>But here’s the thing we rarely ever say: None of this has any inherent value.<br /><br />Efficiency is only valuable if it helps us move faster towards meaningful outcomes for the people using our products and services.<br /><br />Consistency is only valuable if we standardise things to a good level of quality.<br /><br />And scaling things is only valuable if they’re actually worth reproducing.**[Amy Hupe: Building Conscious Design Systems](https://amyhupe.co.uk/articles/building-conscious-design-systems/)**
