...
I was recently tagged by my friend [Sara Soueidan](https://www.sarasoueidan.com) to describe my [typical day.](https://twitter.com/cdevroe/status/1347181529819193344) It's a trend going around on Twitter, but I enjoy reading these kind of posts from other people, so perhaps some of you will find this interesting too. You can read about [Sara's typical day](https://www.sarasoueidan.com/desk/typical-day/), [Dan Mall's](http://danmall.me/articles/my-typical-day/), or [Chris Coyier's.](https://chriscoyier.net/2021/01/08/my-typical-day/)
...
**11.30 AM - 12.30 PM -** Winter workout time. I like breaking up the day into segments and this allows me to sort of reset my brain for the afternoon. If the weather is nice, I'll go for a run, but when it's not, I'll likely use [my Waterrower](https://www.waterrower.com) or dumbbells at home instead.
...
- **Things.** I have projects setup for all client projects, but also private projects (from grocery shopping to long term goals). I then use the 'When' feature to assign dates for everything so I know each morning what I have to accomplish during the day. Once the 'Today' list is all taken care of, I can head into a specific project to cross of additional tasks if I'm on roll. The list isn't definitive though, I'll keep my days flexible enough so that most days, almost any of the tasks could be moved until the next day.
  ...
  ![Typical day in Things](typical-day.png)
