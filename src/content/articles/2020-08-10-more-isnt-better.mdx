...
If you've followed my work for some time, you know [I enjoy discovering new products](/newtools/) and surgically inspecting how they work, what features they have, and how they've decided to solve some of the common UX problems. To be honest, this is one of the ways I learn and develop a lot of my skills - by reviewing and understanding what others do.
...
For years, I've used GoSquared instead of Google Analytics to track users on my website. I keep track of what articles have the most reads (it's [AI Ethics - A New Skill for Designers](/ai-ethics/)), who's tweeting my about my site, and where my visitors are coming from (about 60% are from the US). As much as I still love the team behind GoSquared, my website now only runs [Fathom](https://usefathom.com/ref/ZTSEBE). Here's my problem... You see, during the last years GoSquared has focused more on automations, identifying users, and being able to communicate with them - so more Intercom than Google Analytics. With Fathom, I can run privacy-focused analytics and get almost the same amount information. After all, most metrics are really only [vanity metrics](/vanitymetrics/) anyway.  

If you're subscribed to [my newsletter](/newsletter), you'll know that I've tried my fair share of tools - Mailchimp, Drip, Convertkit, Buttondown, Mailerlite... and now I'm back on [Mailchimp](http://eepurl.com/g_YAyz). I still feel like they are doing way too many things, but unlike with analytics, I haven't found a great alternative. Most email marketing tools are either solely focused on automations, transactions, and e-commerce or trying to be a full-fledged CRM. Me, I just want to be able to email my list every other week and tell them about what I've been thinking about lately. I don't need all the complexity.

I was reading Derek Sivers' new book [Hell Yeah or No](https://sivers.org/n) the other day and the chapter [Subtract](https://sivers.org/subtract) stood out:
...
If you're curious about what tools I'm currently using the run my business, I've just [updated my list.](/tools/)