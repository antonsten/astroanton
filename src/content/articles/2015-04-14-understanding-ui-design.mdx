...
Whilst both UX Design and UI Design work closely together, [each role refers to extremely different processes](https://www.designerhire.com/ui-ux-designer) when it comes to designing and building a website. Though this does not stop people from misrepresenting or misunderstanding both roles.
