...
[Paul Graham](https://paulgraham.com/), co-founder of Y-combinator on the importance of talking to your customers (and why most companies don’t do it): 
...
As a consultant, it’s not uncommon to have to wear many hats. In fact, I think one of the greatest skills to have as a consultant is the ability to adapt and change. There’s a lot of talk about what niche you should focus on and developing a tailored approach. While that may be helpful to a small subset of people, it’s rare to make a living out of doing just one specific thing. Not to mention, if you ask me, it’d probably become… dull? So yes, over the years I’ve had to do [research](https://www.antonsten.com/writing/stakeholder), [UX](https://www.antonsten.com/writing/ux-design-explained), and, [UI](https://www.antonsten.com/writing/understanding-ui-design) myself. 

The way to disconnect yourself from the work while doing research is to focus solely on what you’re researching. For instance, I’d start by making sure I could clearly define the problem, constraints, and requirements. This can be done through [stakeholder interviews](https://www.antonsten.com/writing/stakeholder), but also by talking to customers. The key here is to not focus on “solutionizing”, but understanding the problem and making sure that there’s an aligned view of what the problem is across all stakeholders. 
