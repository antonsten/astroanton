...
One of recurring topics of this blog over the past year has surely been Design Principles. I've helped form Design Principles for the projects I've worked on, I've held classes at [Hyper Island on Design Principles](/design-principles/) (although I kinda pivoted it to Design Process), and I've [helped coach](/coaching) other designers on how to form actionable Design Principles. But I never really dove into *what* they are and why they are important.

## Definition

The website [Design Principles](https://principles.design) (touché) clearly states principles as:

>Design Principles are a set of considerations that form the basis of any good product.**[Design Principles](https://principles.design)**
...
Another example is AirBnB that has *"Conversational"* as one of their principles. While this is true for most of their website, if you look at their [Privacy Policy](https://www.airbnb.com/help/article/2855/privacy-policy) you can easily tell that it's just legalese. It's easy to argue that it's written by lawyers and that it has to be a certain way. But if one of your principles is to be Conversational, why not look at [what LinkedIn does?](https://www.linkedin.com/legal/privacy-policy) On top of every section, they explain the section in plain English. You can have legalese AND still be conversational.
