...
>For instance, it's well-known that at the very beginning of the meal and at the very end, time seems to slow down. In those moments, the guest has a heightened sensitivity to any delay- we can all relate to feeling like we've been waiting hours for that first glass of water or for the check. So it's crucial to get something -anything- in front of the guest as soon as you can.**["Unreasonable Hospitality"](https://literal.club/book/will-guidara-unreasonable-hospitality-hnvnh)**

While many of us focus on "optimizing checkout experiences" or "creating frictionless onboarding experiences," we often fail to look outside our own arena for inspiration. So, rather than thinking it's all [about speed](/secret-feature/) (a poor example, as it really is all about speed), what if you could get something in front of your user?